  ...
  return function (callback) {
    ...
    if (cluster.isMaster) {
      ...
      prompt.get(promptSchema, function (err, result) {
        ...
        var files = [`${result.path}FASTChronological.nt`, `${result.path}FASTFormGenre.nt`, `${result.path}FASTCorporate.nt`, `${result.path}FASTEvent.nt`, `${result.path}FASTGeographic.nt`, `${result.path}FASTPersonal.nt`, `${result.path}FASTTopical.nt`]
